...
{	
	...
	inline void(*FMemory_Free)(void*) = decltype(FMemory_Free)(__int64(GetModuleHandleW(0)) + 0x25B29E0);
	inline void* (*FMemory_Realloc)(void*, size_t Count, uint32 Alignment) = decltype(FMemory_Realloc)(__int64(GetModuleHandleW(0)) + 0x25C64B0);
	...
	public:
		...
		inline void Reserve(int32 Count)
		{
			...
			Data = (ArrayElementType*)FMemory_Realloc(Data, MaxElements * sizeof(ArrayElementType), 0);
		}
