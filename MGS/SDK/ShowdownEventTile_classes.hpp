...
public:
	...
	TMulticastInlineDelegate<void()>              OnWindowSelected;                                  // 0x0C00(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
