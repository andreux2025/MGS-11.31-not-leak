...
static_assert(sizeof(UGA_DefaultPlayer_PetOtherPet_C) == 0x000A38, "Wrong size on UGA_DefaultPlayer_PetOtherPet_C");
static_assert(offsetof(UGA_DefaultPlayer_PetOtherPet_C, UberGraphFrame) == 0x000A30, "Member 'UGA_DefaultPlayer_PetOtherPet_C::UberGraphFrame' has a wrong offset!");
