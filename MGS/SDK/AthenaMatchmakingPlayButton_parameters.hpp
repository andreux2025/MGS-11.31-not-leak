...
static_assert(alignof(AthenaMatchmakingPlayButton_C_ExecuteUbergraph_AthenaMatchmakingPlayButton) == 0x000004, "Wrong alignment on AthenaMatchmakingPlayButton_C_ExecuteUbergraph_AthenaMatchmakingPlayButton");
static_assert(sizeof(AthenaMatchmakingPlayButton_C_ExecuteUbergraph_AthenaMatchmakingPlayButton) == 0x000008, "Wrong size on AthenaMatchmakingPlayButton_C_ExecuteUbergraph_AthenaMatchmakingPlayButton");
...
static_assert(offsetof(AthenaMatchmakingPlayButton_C_ExecuteUbergraph_AthenaMatchmakingPlayButton, K2Node_Event_IsDesignTime) == 0x000004, "Member 'AthenaMatchmakingPlayButton_C_ExecuteUbergraph_AthenaMatchmakingPlayButton::K2Node_Event_IsDesignTime' has a wrong offset!");
