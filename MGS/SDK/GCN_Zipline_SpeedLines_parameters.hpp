...
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_Add_VectorVector_ReturnValue_1) == 0x000270, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_Add_VectorVector_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_Multiply_VectorFloat_ReturnValue_1) == 0x000380, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_Multiply_VectorFloat_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_Conv_VectorToRotator_ReturnValue_1) == 0x000398, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_Conv_VectorToRotator_ReturnValue_1' has a wrong offset!");
