...
public:
	...
	uint32                                        DetailLevelMask;                                   // 0x0038(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FNiagaraVMExecutableDataId) == 0x000050, "Wrong size on FNiagaraVMExecutableDataId");
...
static_assert(offsetof(FNiagaraVMExecutableDataId, DetailLevelMask) == 0x000038, "Member 'FNiagaraVMExecutableDataId::DetailLevelMask' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableDataId, bUsesRapidIterationParams) == 0x00003C, "Member 'FNiagaraVMExecutableDataId::bUsesRapidIterationParams' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableDataId, BaseScriptID) == 0x000040, "Member 'FNiagaraVMExecutableDataId::BaseScriptID' has a wrong offset!");
...
static_assert(offsetof(FNiagaraTypeDefinition, struct_0) == 0x000000, "Member 'FNiagaraTypeDefinition::struct_0' has a wrong offset!");
...
struct FNiagaraVariableWithOffset final : public FNiagaraVariable
{
public:
...
static_assert(sizeof(FNiagaraVariableWithOffset) == 0x000038, "Wrong size on FNiagaraVariableWithOffset");
static_assert(offsetof(FNiagaraVariableWithOffset, Offset) == 0x000030, "Member 'FNiagaraVariableWithOffset::Offset' has a wrong offset!");
...
static_assert(sizeof(FEmitterCompiledScriptPair) == 0x000080, "Wrong size on FEmitterCompiledScriptPair");
...
public:
	...
	uint8                                         bNeedsPersistentIDs : 1;                           // 0x0028(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(FNiagaraUserParameterBinding) == 0x000030, "Wrong size on FNiagaraUserParameterBinding");
...
static_assert(sizeof(FVMExternalFunctionBindingInfo) == 0x000078, "Wrong size on FVMExternalFunctionBindingInfo");
...
static_assert(offsetof(FVMExternalFunctionBindingInfo, Specifiers) == 0x000028, "Member 'FVMExternalFunctionBindingInfo::Specifiers' has a wrong offset!");
...
static_assert(sizeof(FNiagaraEmitterCompiledData) == 0x000170, "Wrong size on FNiagaraEmitterCompiledData");
...
static_assert(offsetof(FNiagaraEmitterCompiledData, EmitterInterpSpawnStartDTVar) == 0x000040, "Member 'FNiagaraEmitterCompiledData::EmitterInterpSpawnStartDTVar' has a wrong offset!");
static_assert(offsetof(FNiagaraEmitterCompiledData, EmitterSpawnGroupVar) == 0x000070, "Member 'FNiagaraEmitterCompiledData::EmitterSpawnGroupVar' has a wrong offset!");
static_assert(offsetof(FNiagaraEmitterCompiledData, EmitterAgeVar) == 0x0000A0, "Member 'FNiagaraEmitterCompiledData::EmitterAgeVar' has a wrong offset!");
static_assert(offsetof(FNiagaraEmitterCompiledData, EmitterRandomSeedVar) == 0x0000D0, "Member 'FNiagaraEmitterCompiledData::EmitterRandomSeedVar' has a wrong offset!");
static_assert(offsetof(FNiagaraEmitterCompiledData, EmitterTotalSpawnedParticlesVar) == 0x000100, "Member 'FNiagaraEmitterCompiledData::EmitterTotalSpawnedParticlesVar' has a wrong offset!");
static_assert(offsetof(FNiagaraEmitterCompiledData, DataSetCompiledData) == 0x000130, "Member 'FNiagaraEmitterCompiledData::DataSetCompiledData' has a wrong offset!");
...
static_assert(sizeof(FNiagaraMeshMaterialOverride) == 0x000038, "Wrong size on FNiagaraMeshMaterialOverride");
...
static_assert(sizeof(FNiagaraBoundParameter) == 0x000038, "Wrong size on FNiagaraBoundParameter");
...
static_assert(offsetof(FNiagaraBoundParameter, SrcOffset) == 0x000030, "Member 'FNiagaraBoundParameter::SrcOffset' has a wrong offset!");
static_assert(offsetof(FNiagaraBoundParameter, DestOffset) == 0x000034, "Member 'FNiagaraBoundParameter::DestOffset' has a wrong offset!");
...
public:
	...
	TMap<class FName, struct FNiagaraParameters>  DataSetToParameters;                               // 0x0048(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraVariable>               Attributes;                                        // 0x0098(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	struct FNiagaraScriptDataUsageInfo            DataUsage;                                         // 0x00A8(0x0001)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FNiagaraFunctionSignature>      AdditionalExternalFunctions;                       // 0x00B0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraScriptDataInterfaceCompileInfo> DataInterfaceInfo;                                 // 0x00C0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FVMExternalFunctionBindingInfo> CalledVMExternalFunctions;                         // 0x00D0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraDataSetID>              ReadDataSets;                                      // 0x00E0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraDataSetProperties>      WriteDataSets;                                     // 0x00F0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraStatScope>              StatScopes;                                        // 0x0100(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraDataInterfaceGPUParamInfo> DIParamInfo;                                       // 0x0110(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FNiagaraVMExecutableData, AdditionalExternalFunctions) == 0x0000B0, "Member 'FNiagaraVMExecutableData::AdditionalExternalFunctions' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, DataInterfaceInfo) == 0x0000C0, "Member 'FNiagaraVMExecutableData::DataInterfaceInfo' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, CalledVMExternalFunctions) == 0x0000D0, "Member 'FNiagaraVMExecutableData::CalledVMExternalFunctions' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, ReadDataSets) == 0x0000E0, "Member 'FNiagaraVMExecutableData::ReadDataSets' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, WriteDataSets) == 0x0000F0, "Member 'FNiagaraVMExecutableData::WriteDataSets' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, StatScopes) == 0x000100, "Member 'FNiagaraVMExecutableData::StatScopes' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, DIParamInfo) == 0x000110, "Member 'FNiagaraVMExecutableData::DIParamInfo' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, LastCompileStatus) == 0x000120, "Member 'FNiagaraVMExecutableData::LastCompileStatus' has a wrong offset!");
...
{
public:
	uint32                                        SrcOffset;                                         // 0x0000(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        DestOffset;                                        // 0x0004(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        SrcSize;                                           // 0x0008(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        DestSize;                                          // 0x000C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FNiagaraScriptExecutionPaddingInfo, DestOffset) == 0x000004, "Member 'FNiagaraScriptExecutionPaddingInfo::DestOffset' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptExecutionPaddingInfo, SrcSize) == 0x000008, "Member 'FNiagaraScriptExecutionPaddingInfo::SrcSize' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptExecutionPaddingInfo, DestSize) == 0x00000C, "Member 'FNiagaraScriptExecutionPaddingInfo::DestSize' has a wrong offset!");
...
static_assert(sizeof(FNiagaraSystemCompiledData) == 0x0001A8, "Wrong size on FNiagaraSystemCompiledData");
static_assert(offsetof(FNiagaraSystemCompiledData, NumParticleVars) == 0x000000, "Member 'FNiagaraSystemCompiledData::NumParticleVars' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, TotalSpawnedParticlesVars) == 0x000010, "Member 'FNiagaraSystemCompiledData::TotalSpawnedParticlesVars' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, InstanceParamStore) == 0x000020, "Member 'FNiagaraSystemCompiledData::InstanceParamStore' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, SpawnCountScaleVars) == 0x0000D8, "Member 'FNiagaraSystemCompiledData::SpawnCountScaleVars' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, DataSetCompiledData) == 0x0000E8, "Member 'FNiagaraSystemCompiledData::DataSetCompiledData' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, SpawnInstanceParamsDataSetCompiledData) == 0x000128, "Member 'FNiagaraSystemCompiledData::SpawnInstanceParamsDataSetCompiledData' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemCompiledData, UpdateInstanceParamsDataSetCompiledData) == 0x000168, "Member 'FNiagaraSystemCompiledData::UpdateInstanceParamsDataSetCompiledData' has a wrong offset!");
