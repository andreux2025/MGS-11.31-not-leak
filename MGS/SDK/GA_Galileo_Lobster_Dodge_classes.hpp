...
class UGA_Galileo_Lobster_Dodge_C final : public UFortGameplayAbility
{
public:
...
static_assert(sizeof(UGA_Galileo_Lobster_Dodge_C) == 0x000AB0, "Wrong size on UGA_Galileo_Lobster_Dodge_C");
