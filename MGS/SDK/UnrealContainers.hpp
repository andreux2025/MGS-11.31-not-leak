...
{	
	...
	inline void(*FMemory_Free)(void*) = decltype(FMemory_Free)(GetImageBase() + 0x25B29E0);
	inline void* (*FMemory_Realloc)(void*, size_t Count, uint32 Alignment) = decltype(FMemory_Realloc)(GetImageBase() + 0x25C64B0);
