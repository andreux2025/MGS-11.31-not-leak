...
public:
	...
	TArray<TSubclassOf<class UCommonInputControllerData>> ControllerDataClasses;                             // 0x0018(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
};
