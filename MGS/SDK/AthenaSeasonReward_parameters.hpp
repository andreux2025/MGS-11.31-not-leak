...
static_assert(sizeof(AthenaSeasonReward_C_ShowNextVariant) == 0x000118, "Wrong size on AthenaSeasonReward_C_ShowNextVariant");
...
static_assert(offsetof(AthenaSeasonReward_C_ShowNextVariant, CallFunc_Array_Length_ReturnValue_1) == 0x0000E8, "Member 'AthenaSeasonReward_C_ShowNextVariant::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_ShowNextVariant, CallFunc_Less_IntInt_ReturnValue) == 0x0000EC, "Member 'AthenaSeasonReward_C_ShowNextVariant::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_ShowNextVariant, K2Node_MakeStruct_UnlockableVariantPreviewInfo) == 0x0000F0, "Member 'AthenaSeasonReward_C_ShowNextVariant::K2Node_MakeStruct_UnlockableVariantPreviewInfo' has a wrong offset!");
