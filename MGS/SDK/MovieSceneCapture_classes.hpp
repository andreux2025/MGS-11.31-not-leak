...
public:
	...
	uint8                                         Pad_110[0x108];                                    // 0x0110(0x0108)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneCapture) == 0x000218, "Wrong size on UMovieSceneCapture");
...
public:
	...
	uint8                                         Pad_219[0xB];                                      // 0x0219(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULevelCapture) == 0x000238, "Wrong size on ULevelCapture");
static_assert(offsetof(ULevelCapture, bAutoStartCapture) == 0x000218, "Member 'ULevelCapture::bAutoStartCapture' has a wrong offset!");
static_assert(offsetof(ULevelCapture, PrerequisiteActorId) == 0x000224, "Member 'ULevelCapture::PrerequisiteActorId' has a wrong offset!");
