...
static_assert(sizeof(NiagaraDataInterfaceGrid2DCollection_FillRawTexture2D) == 0x000018, "Wrong size on NiagaraDataInterfaceGrid2DCollection_FillRawTexture2D");
