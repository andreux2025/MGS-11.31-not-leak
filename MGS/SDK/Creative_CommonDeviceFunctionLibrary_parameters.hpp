...
public:
	...
	TScriptInterface<class IFortVehicleInterface> K2Node_DynamicCast_AsFort_Vehicle_Interface;       // 0x0080(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0090(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_91[0x7];                                       // 0x0091(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AFortPlayerPawn*                        CallFunc_GetDriver_ReturnValue;                    // 0x0098(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller) == 0x0000A0, "Wrong size on Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller, CallFunc_IsValid_ReturnValue) == 0x000050, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller, CallFunc_GetController_ReturnValue) == 0x000058, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller::CallFunc_GetController_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller, CallFunc_GetFortPlayerControllerFromActor_ReturnValue) == 0x000060, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller::CallFunc_GetFortPlayerControllerFromActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller, CallFunc_IsValid_ReturnValue_1) == 0x000068, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller, CallFunc_GetAbilitySystemComponent_ReturnValue) == 0x000070, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller::CallFunc_GetAbilitySystemComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller, CallFunc_IsValid_ReturnValue_2) == 0x000078, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller, K2Node_DynamicCast_AsFort_Vehicle_Interface) == 0x000080, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller::K2Node_DynamicCast_AsFort_Vehicle_Interface' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller, K2Node_DynamicCast_bSuccess) == 0x000090, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller, CallFunc_GetDriver_ReturnValue) == 0x000098, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Driver_or_Pawn_Controller::CallFunc_GetDriver_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_or_Team_Index, CallFunc_MakeLiteralByte_ReturnValue) == 0x00001C, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_or_Team_Index::CallFunc_MakeLiteralByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_or_Team_Index, CallFunc_Conv_IntToByte_ReturnValue) == 0x00001D, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_or_Team_Index::CallFunc_Conv_IntToByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_or_Team_Index, CallFunc_Add_ByteByte_ReturnValue) == 0x00001E, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_or_Team_Index::CallFunc_Add_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_or_Team_Index, CallFunc_IsValid_ReturnValue) == 0x00001F, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_or_Team_Index::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_or_Team_Index, CallFunc_IsValid_ReturnValue_1) == 0x000025, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_or_Team_Index::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_or_Team_Index, Temp_bool_Variable) == 0x000026, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_or_Team_Index::Temp_bool_Variable' has a wrong offset!");
