...
public:
	...
	class UWidgetAnimation*                       OnLoad_Locked;                                     // 0x0BC0(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	class UWidgetAnimation*                       OnLoad_Unlocked;                                   // 0x0BC8(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UChallengeImageGrid_Button_C, OnLoad_Locked) == 0x000BC0, "Member 'UChallengeImageGrid_Button_C::OnLoad_Locked' has a wrong offset!");
static_assert(offsetof(UChallengeImageGrid_Button_C, OnLoad_Unlocked) == 0x000BC8, "Member 'UChallengeImageGrid_Button_C::OnLoad_Unlocked' has a wrong offset!");
