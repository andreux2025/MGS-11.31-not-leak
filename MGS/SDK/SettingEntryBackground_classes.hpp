...
public:
	...
	TMulticastInlineDelegate<void(bool IsEnterEvent)> OnMouseEnterChanged;                               // 0x0248(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
