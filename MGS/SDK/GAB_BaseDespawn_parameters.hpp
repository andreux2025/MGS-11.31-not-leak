...
public:
	...
	class AFortAIPawn*                            K2Node_DynamicCast_AsFort_AIPawn;                  // 0x00C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(GAB_BaseDespawn_C_ExecuteUbergraph_GAB_BaseDespawn) == 0x0000D8, "Wrong size on GAB_BaseDespawn_C_ExecuteUbergraph_GAB_BaseDespawn");
...
static_assert(offsetof(GAB_BaseDespawn_C_ExecuteUbergraph_GAB_BaseDespawn, CallFunc_K2_CommitAbility_ReturnValue) == 0x0000B8, "Member 'GAB_BaseDespawn_C_ExecuteUbergraph_GAB_BaseDespawn::CallFunc_K2_CommitAbility_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAB_BaseDespawn_C_ExecuteUbergraph_GAB_BaseDespawn, K2Node_DynamicCast_AsFort_AIPawn) == 0x0000C0, "Member 'GAB_BaseDespawn_C_ExecuteUbergraph_GAB_BaseDespawn::K2Node_DynamicCast_AsFort_AIPawn' has a wrong offset!");
static_assert(offsetof(GAB_BaseDespawn_C_ExecuteUbergraph_GAB_BaseDespawn, K2Node_DynamicCast_bSuccess) == 0x0000C8, "Member 'GAB_BaseDespawn_C_ExecuteUbergraph_GAB_BaseDespawn::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(GAB_BaseDespawn_C_ExecuteUbergraph_GAB_BaseDespawn, CallFunc_GetController_ReturnValue) == 0x0000D0, "Member 'GAB_BaseDespawn_C_ExecuteUbergraph_GAB_BaseDespawn::CallFunc_GetController_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(GAB_BaseDespawn_C_K2_ActivateAbilityFromEvent) == 0x0000B0, "Wrong size on GAB_BaseDespawn_C_K2_ActivateAbilityFromEvent");
