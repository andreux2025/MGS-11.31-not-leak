...
static_assert(sizeof(GAB_NotIdling_C_ExecuteUbergraph_GAB_NotIdling) == 0x0000B8, "Wrong size on GAB_NotIdling_C_ExecuteUbergraph_GAB_NotIdling");
...
static_assert(sizeof(GAB_NotIdling_C_K2_ActivateAbilityFromEvent) == 0x0000B0, "Wrong size on GAB_NotIdling_C_K2_ActivateAbilityFromEvent");
