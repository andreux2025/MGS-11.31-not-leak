...
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_MatchesAnyTags_ReturnValue_1) == 0x000019, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_MatchesAnyTags_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_BooleanAND_ReturnValue) == 0x00001A, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_BooleanOR_ReturnValue) == 0x00001B, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
