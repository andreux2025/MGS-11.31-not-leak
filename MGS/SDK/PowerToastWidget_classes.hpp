...
public:
	...
	struct FTimerHandle                           AnimationDelayTimer;                               // 0x02E8(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UPowerToastWidget_C) == 0x0002F0, "Wrong size on UPowerToastWidget_C");
...
static_assert(offsetof(UPowerToastWidget_C, PowerIconGlow) == 0x0002D0, "Member 'UPowerToastWidget_C::PowerIconGlow' has a wrong offset!");
static_assert(offsetof(UPowerToastWidget_C, ToastNotification) == 0x0002D8, "Member 'UPowerToastWidget_C::ToastNotification' has a wrong offset!");
static_assert(offsetof(UPowerToastWidget_C, AnimationFinishedDelay) == 0x0002E0, "Member 'UPowerToastWidget_C::AnimationFinishedDelay' has a wrong offset!");
