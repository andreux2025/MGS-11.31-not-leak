...
static_assert(sizeof(UGA_Athena_HidingProp_BlockMovement_C) == 0x000A38, "Wrong size on UGA_Athena_HidingProp_BlockMovement_C");
static_assert(offsetof(UGA_Athena_HidingProp_BlockMovement_C, UberGraphFrame) == 0x000A30, "Member 'UGA_Athena_HidingProp_BlockMovement_C::UberGraphFrame' has a wrong offset!");
