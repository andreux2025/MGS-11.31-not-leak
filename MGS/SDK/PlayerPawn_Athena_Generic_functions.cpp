...
// Parameters:
// class AActor*                           DamageCauser                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    DoPawnDamageFX                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void APlayerPawn_Athena_Generic_C::ShouldDoPawnDamageFX(class AActor* DamageCauser, bool* DoPawnDamageFX)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlayerPawn_Athena_Generic_C", "ShouldDoPawnDamageFX");

	Params::PlayerPawn_Athena_Generic_C_ShouldDoPawnDamageFX Parms{};

	Parms.DamageCauser = DamageCauser;

	UObject::ProcessEvent(Func, &Parms);

	if (DoPawnDamageFX != nullptr)
		*DoPawnDamageFX = Parms.DoPawnDamageFX;
}
