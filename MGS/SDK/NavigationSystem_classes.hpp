...
static_assert(sizeof(UNavLinkRenderingComponent) == 0x0003E0, "Wrong size on UNavLinkRenderingComponent");
...
static_assert(sizeof(ANavModifierVolume) == 0x000260, "Wrong size on ANavModifierVolume");
...
static_assert(sizeof(UNavMeshRenderingComponent) == 0x0003F0, "Wrong size on UNavMeshRenderingComponent");
...
static_assert(sizeof(ANavigationTestingActor) == 0x000300, "Wrong size on ANavigationTestingActor");
...
static_assert(offsetof(ANavigationTestingActor, CostDisplayMode) == 0x000298, "Member 'ANavigationTestingActor::CostDisplayMode' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, TextCanvasOffset) == 0x00029C, "Member 'ANavigationTestingActor::TextCanvasOffset' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, PathfindingTime) == 0x0002A8, "Member 'ANavigationTestingActor::PathfindingTime' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, PathCost) == 0x0002AC, "Member 'ANavigationTestingActor::PathCost' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, PathfindingSteps) == 0x0002B0, "Member 'ANavigationTestingActor::PathfindingSteps' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, OtherActor) == 0x0002B8, "Member 'ANavigationTestingActor::OtherActor' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, FilterClass) == 0x0002C0, "Member 'ANavigationTestingActor::FilterClass' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, ShowStepIndex) == 0x0002C8, "Member 'ANavigationTestingActor::ShowStepIndex' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, OffsetFromCornersDistance) == 0x0002CC, "Member 'ANavigationTestingActor::OffsetFromCornersDistance' has a wrong offset!");
...
static_assert(sizeof(UNavLinkComponent) == 0x0003F0, "Wrong size on UNavLinkComponent");
static_assert(offsetof(UNavLinkComponent, Links) == 0x0003E0, "Member 'UNavLinkComponent::Links' has a wrong offset!");
...
static_assert(sizeof(UNavTestRenderingComponent) == 0x0003E0, "Wrong size on UNavTestRenderingComponent");
