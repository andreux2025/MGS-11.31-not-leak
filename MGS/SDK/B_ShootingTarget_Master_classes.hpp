...
public:
	...
	TArray<class UPrimitiveComponent*>            WeakPointArray;                                    // 0x0ED8(0x0010)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference)
