...
public:
	...
	TMulticastInlineDelegate<void()>              BannerTileBangUpdated;                             // 0x0BC0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
