...
static_assert(sizeof(UGA_SlamDoorOpen_Instigator_C) == 0x000A38, "Wrong size on UGA_SlamDoorOpen_Instigator_C");
static_assert(offsetof(UGA_SlamDoorOpen_Instigator_C, UberGraphFrame) == 0x000A30, "Member 'UGA_SlamDoorOpen_Instigator_C::UberGraphFrame' has a wrong offset!");
