...
// struct FFortAnimInput_TurnInPlace       TurnInPlace_0                                          (BlueprintVisible, BlueprintReadOnly, Parm)
// struct FPoseLink                        VehicleSplitBodyOverride_0                             (Parm, OutParm, NoDestructor)

void UFortnite_M_Avg_Player_AnimBlueprint_C::VehicleSplitBodyOverride(const struct FPoseLink& InPoseSplitBody, const struct FPoseLink& InPoseInPoseUpperAndLowerBody, const struct FFortAnimInput_TurnInPlace& TurnInPlace_0, struct FPoseLink* VehicleSplitBodyOverride_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.InPoseInPoseUpperAndLowerBody = std::move(InPoseInPoseUpperAndLowerBody);
	Parms.TurnInPlace_0 = std::move(TurnInPlace_0);
...
void UFortnite_M_Avg_Player_AnimBlueprint_C::ItemUpperBody(const struct FPoseLink& InPoseUpperBody, const struct FFortAnimInput_AdjustedAim& InputParam_0, struct FPoseLink* ItemUpperBody_0)
{
	static class UFunction* Func = nullptr;
...
// float                                   AimOffsetAlpha_0                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UFortnite_M_Avg_Player_AnimBlueprint_C::ItemAimOffset(const struct FPoseLink& InPose_AimOffset, float AimOffsetAlpha_0, float Yaw_0, float Pitch_0, const struct FPoseLink& InPose_UpperLowerPreMeleeAO, struct FPoseLink* ItemAimOffset_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.AimOffsetAlpha_0 = AimOffsetAlpha_0;
	Parms.Yaw_0 = Yaw_0;
...
void UFortnite_M_Avg_Player_AnimBlueprint_C::SwimmingSprintLayer(const struct FPoseLink& PassThroughSwimmingSprint, struct FPoseLink* SwimmingSprintLayer_0)
{
	static class UFunction* Func = nullptr;
...
// bool                                    isDBNOLayer_0                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UFortnite_M_Avg_Player_AnimBlueprint_C::SwimmingAdditiveLayer(const struct FPoseLink& IdleAdditive_Cache, const struct FPoseLink& MovementAdditiveLayerPose_Cache, const struct FPoseLink& FullBody, float PlayMeleeAttackAOLayer_0, float DisableArmsHeadAdditiveCurveAlphaLayer_0, float DisableIKRootAdditiveCurveAlphaLayer_0, float LocomotionAdditiveAlphaLayer_0, bool isDBNOLayer_0, const struct FPoseLink& UpperAndLowerBody_Cache, const struct FPoseLink& SprintingPose_PostMask_Cache, struct FPoseLink* SwimmingAdditiveLayer_0)
{
	...
	Parms.isDBNOLayer_0 = isDBNOLayer_0;
...
void UFortnite_M_Avg_Player_AnimBlueprint_C::SwimmingDiveJumpingLayer(const struct FPoseLink& PassThroughSwimmingDiveJumping, struct FPoseLink* SwimmingDiveJumpingLayer_0)
{
	static class UFunction* Func = nullptr;
