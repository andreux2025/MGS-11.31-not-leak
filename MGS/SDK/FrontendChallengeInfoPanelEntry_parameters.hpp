...
static_assert(offsetof(FrontendChallengeInfoPanelEntry_C_ExecuteUbergraph_FrontendChallengeInfoPanelEntry, CallFunc_PlayAnimationForward_ReturnValue) == 0x000008, "Member 'FrontendChallengeInfoPanelEntry_C_ExecuteUbergraph_FrontendChallengeInfoPanelEntry::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
static_assert(offsetof(FrontendChallengeInfoPanelEntry_C_ExecuteUbergraph_FrontendChallengeInfoPanelEntry, CallFunc_PlayAnimation_ReturnValue) == 0x000010, "Member 'FrontendChallengeInfoPanelEntry_C_ExecuteUbergraph_FrontendChallengeInfoPanelEntry::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
