...
public:
	...
	class UCommonBorder*                          CommonBorderFlavortext_01;                         // 0x02F8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonBorder*                          CommonBorderFlavortext_02;                         // 0x0300(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	bool                                          IsHeroLoadOut_Tooltip;                             // 0x0348(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
...
static_assert(offsetof(UHeroLoadoutPerksDetailWidget_C, CommonBorderFlavortext_01) == 0x0002F8, "Member 'UHeroLoadoutPerksDetailWidget_C::CommonBorderFlavortext_01' has a wrong offset!");
static_assert(offsetof(UHeroLoadoutPerksDetailWidget_C, CommonBorderFlavortext_02) == 0x000300, "Member 'UHeroLoadoutPerksDetailWidget_C::CommonBorderFlavortext_02' has a wrong offset!");
...
static_assert(offsetof(UHeroLoadoutPerksDetailWidget_C, IsHeroLoadOut_Tooltip) == 0x000348, "Member 'UHeroLoadoutPerksDetailWidget_C::IsHeroLoadOut_Tooltip' has a wrong offset!");
