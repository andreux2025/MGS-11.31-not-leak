...
static_assert(sizeof(PlayerBanner_C_ExecuteUbergraph_PlayerBanner) == 0x000240, "Wrong size on PlayerBanner_C_ExecuteUbergraph_PlayerBanner");
...
static_assert(offsetof(PlayerBanner_C_ExecuteUbergraph_PlayerBanner, CallFunc_ShouldShowAthenaBanner_ShowAthenaBanner) == 0x000004, "Member 'PlayerBanner_C_ExecuteUbergraph_PlayerBanner::CallFunc_ShouldShowAthenaBanner_ShowAthenaBanner' has a wrong offset!");
...
static_assert(sizeof(PlayerBanner_C_SetBannerIconAndColorFromProfile) == 0x000160, "Wrong size on PlayerBanner_C_SetBannerIconAndColorFromProfile");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_ShouldShowAthenaBanner_ShowAthenaBanner) == 0x000000, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_ShouldShowAthenaBanner_ShowAthenaBanner' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_GetContext_ReturnValue) == 0x000008, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_GetContext_ReturnValue_1) == 0x000010, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_GetContext_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_GetHomeBaseInfoForPlayer_Result) == 0x000018, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_GetHomeBaseInfoForPlayer_Result' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_GetLoadoutForPlayer_ReturnValue) == 0x000058, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_GetLoadoutForPlayer_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_Conv_StringToName_ReturnValue) == 0x00014C, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_Conv_StringToName_ReturnValue_1) == 0x000154, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_Conv_StringToName_ReturnValue_1' has a wrong offset!");
...
static_assert(alignof(PlayerBanner_C_ShouldShowAthenaBanner) == 0x000008, "Wrong alignment on PlayerBanner_C_ShouldShowAthenaBanner");
static_assert(sizeof(PlayerBanner_C_ShouldShowAthenaBanner) == 0x000020, "Wrong size on PlayerBanner_C_ShouldShowAthenaBanner");
static_assert(offsetof(PlayerBanner_C_ShouldShowAthenaBanner, ShowAthenaBanner) == 0x000000, "Member 'PlayerBanner_C_ShouldShowAthenaBanner::ShowAthenaBanner' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_ShouldShowAthenaBanner, CallFunc_GetRuntimeOptions_ReturnValue) == 0x000008, "Member 'PlayerBanner_C_ShouldShowAthenaBanner::CallFunc_GetRuntimeOptions_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_ShouldShowAthenaBanner, CallFunc_GetContext_ReturnValue) == 0x000010, "Member 'PlayerBanner_C_ShouldShowAthenaBanner::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_ShouldShowAthenaBanner, CallFunc_GetSubGame_ReturnValue) == 0x000018, "Member 'PlayerBanner_C_ShouldShowAthenaBanner::CallFunc_GetSubGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_ShouldShowAthenaBanner, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000019, "Member 'PlayerBanner_C_ShouldShowAthenaBanner::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_ShouldShowAthenaBanner, CallFunc_BooleanOR_ReturnValue) == 0x00001A, "Member 'PlayerBanner_C_ShouldShowAthenaBanner::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
