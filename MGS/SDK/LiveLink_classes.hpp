...
public:
	...
	struct FDirectoryPath                         PresetSaveDir;                                     // 0x0038(0x0010)(Edit, Config, NativeAccessSpecifierPublic)
	double                                        MessageBusPingRequestFrequency;                    // 0x0048(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	double                                        MessageBusHeartbeatFrequency;                      // 0x0050(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	double                                        MessageBusHeartbeatTimeout;                        // 0x0058(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	double                                        TimeWithoutFrameToBeConsiderAsInvalid;             // 0x0060(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           ValidColor;                                        // 0x0068(0x0010)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           InvalidColor;                                      // 0x0078(0x0010)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ULiveLinkSettings) == 0x000088, "Wrong size on ULiveLinkSettings");
...
static_assert(offsetof(ULiveLinkSettings, PresetSaveDir) == 0x000038, "Member 'ULiveLinkSettings::PresetSaveDir' has a wrong offset!");
static_assert(offsetof(ULiveLinkSettings, MessageBusPingRequestFrequency) == 0x000048, "Member 'ULiveLinkSettings::MessageBusPingRequestFrequency' has a wrong offset!");
static_assert(offsetof(ULiveLinkSettings, MessageBusHeartbeatFrequency) == 0x000050, "Member 'ULiveLinkSettings::MessageBusHeartbeatFrequency' has a wrong offset!");
static_assert(offsetof(ULiveLinkSettings, MessageBusHeartbeatTimeout) == 0x000058, "Member 'ULiveLinkSettings::MessageBusHeartbeatTimeout' has a wrong offset!");
static_assert(offsetof(ULiveLinkSettings, TimeWithoutFrameToBeConsiderAsInvalid) == 0x000060, "Member 'ULiveLinkSettings::TimeWithoutFrameToBeConsiderAsInvalid' has a wrong offset!");
static_assert(offsetof(ULiveLinkSettings, ValidColor) == 0x000068, "Member 'ULiveLinkSettings::ValidColor' has a wrong offset!");
static_assert(offsetof(ULiveLinkSettings, InvalidColor) == 0x000078, "Member 'ULiveLinkSettings::InvalidColor' has a wrong offset!");
