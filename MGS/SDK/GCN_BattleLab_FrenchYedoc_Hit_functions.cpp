...
#include "GCN_BattleLab_FrenchYedoc_Hit_classes.hpp"
#include "GCN_BattleLab_FrenchYedoc_Hit_parameters.hpp"
...
void UGCN_BattleLab_FrenchYedoc_Hit_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	Params::GCN_BattleLab_FrenchYedoc_Hit_C_OnBurst Parms{};
