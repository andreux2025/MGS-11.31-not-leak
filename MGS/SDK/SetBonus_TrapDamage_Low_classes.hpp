...
static_assert(alignof(USetBonus_TrapDamage_Low_C) == 0x000008, "Wrong alignment on USetBonus_TrapDamage_Low_C");
static_assert(sizeof(USetBonus_TrapDamage_Low_C) == 0x000770, "Wrong size on USetBonus_TrapDamage_Low_C");
