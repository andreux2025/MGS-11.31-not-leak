...
static_assert(offsetof(GCL_SpookyMist_Wobble_C_ExecuteUbergraph_GCL_SpookyMist_Wobble, CallFunc_K2_GetActorLocation_ReturnValue_1) == 0x000040, "Member 'GCL_SpookyMist_Wobble_C_ExecuteUbergraph_GCL_SpookyMist_Wobble::CallFunc_K2_GetActorLocation_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(GCL_SpookyMist_Wobble_C_ExecuteUbergraph_GCL_SpookyMist_Wobble, CallFunc_K2_GetActorLocation_ReturnValue_2) == 0x000084, "Member 'GCL_SpookyMist_Wobble_C_ExecuteUbergraph_GCL_SpookyMist_Wobble::CallFunc_K2_GetActorLocation_ReturnValue_2' has a wrong offset!");
