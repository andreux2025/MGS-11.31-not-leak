...
struct GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace final
{
public:
	...
	bool                                          Temp_bool_IsClosed_Variable_1;                     // 0x0004(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          Temp_bool_IsClosed_Variable_2;                     // 0x0005(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AB_Ranged_Ashton_Indigo_Athena_C*       K2Node_DynamicCast_AsB_Ranged_Ashton_Indigo_Athena; // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AFortPawn*                              CallFunc_GetAimedAtEnemy_ReturnValue;              // 0x0038(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_ObjectObject_ReturnValue;      // 0x0040(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace) == 0x000008, "Wrong alignment on GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace");
static_assert(sizeof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace) == 0x000048, "Wrong size on GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace");
static_assert(offsetof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace, Temp_bool_Has_Been_Initd_Variable) == 0x000000, "Member 'GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace::Temp_bool_Has_Been_Initd_Variable' has a wrong offset!");
static_assert(offsetof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace, Temp_bool_Has_Been_Initd_Variable_1) == 0x000001, "Member 'GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace::Temp_bool_Has_Been_Initd_Variable_1' has a wrong offset!");
static_assert(offsetof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace, Temp_bool_IsClosed_Variable) == 0x000002, "Member 'GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace::Temp_bool_IsClosed_Variable' has a wrong offset!");
static_assert(offsetof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace, Temp_bool_Has_Been_Initd_Variable_2) == 0x000003, "Member 'GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace::Temp_bool_Has_Been_Initd_Variable_2' has a wrong offset!");
static_assert(offsetof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace, Temp_bool_IsClosed_Variable_1) == 0x000004, "Member 'GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace::Temp_bool_IsClosed_Variable_1' has a wrong offset!");
static_assert(offsetof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace, Temp_bool_IsClosed_Variable_2) == 0x000005, "Member 'GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace::Temp_bool_IsClosed_Variable_2' has a wrong offset!");
static_assert(offsetof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace, CallFunc_IsValid_ReturnValue) == 0x000006, "Member 'GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace, CallFunc_GetValueAtLevel_ReturnValue) == 0x000008, "Member 'GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace::CallFunc_GetValueAtLevel_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace, CallFunc_GetValueAtLevel_ReturnValue_1) == 0x00000C, "Member 'GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace::CallFunc_GetValueAtLevel_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace, K2Node_DynamicCast_AsPlayer_Pawn_Athena) == 0x000010, "Member 'GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace::K2Node_DynamicCast_AsPlayer_Pawn_Athena' has a wrong offset!");
static_assert(offsetof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace, K2Node_DynamicCast_AsB_Ranged_Ashton_Indigo_Athena) == 0x000020, "Member 'GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace::K2Node_DynamicCast_AsB_Ranged_Ashton_Indigo_Athena' has a wrong offset!");
static_assert(offsetof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace, K2Node_DynamicCast_bSuccess_1) == 0x000028, "Member 'GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace, CallFunc_GetFortPlayerControllerFromActor_ReturnValue) == 0x000030, "Member 'GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace::CallFunc_GetFortPlayerControllerFromActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace, CallFunc_GetAimedAtEnemy_ReturnValue) == 0x000038, "Member 'GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace::CallFunc_GetAimedAtEnemy_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace, CallFunc_EqualEqual_ObjectObject_ReturnValue) == 0x000040, "Member 'GA_Lotus_Mustache_LockOnTargeting_C_TempGetLockOnTargetsTrace::CallFunc_EqualEqual_ObjectObject_ReturnValue' has a wrong offset!");
