...
static_assert(sizeof(UGAB_NotIdling_C) == 0x000A38, "Wrong size on UGAB_NotIdling_C");
static_assert(offsetof(UGAB_NotIdling_C, UberGraphFrame) == 0x000A30, "Member 'UGAB_NotIdling_C::UberGraphFrame' has a wrong offset!");
