...
static_assert(sizeof(UTabTouchOptions_New_C) == 0x000338, "Wrong size on UTabTouchOptions_New_C");
static_assert(offsetof(UTabTouchOptions_New_C, UberGraphFrame) == 0x000330, "Member 'UTabTouchOptions_New_C::UberGraphFrame' has a wrong offset!");
