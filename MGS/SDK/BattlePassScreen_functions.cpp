...
void UBattlePassScreen_C::OnSetGiftButtonLabel(const class FText& MainLabel, const class FText& PriceText)
{
	static class UFunction* Func = nullptr;
	...
	Params::BattlePassScreen_C_OnSetGiftButtonLabel Parms{};

	Parms.MainLabel = std::move(MainLabel);
...
void UBattlePassScreen_C::OnSetPurchasedAnnualPass(bool bIsPurchased)
{
	...
	Params::BattlePassScreen_C_OnSetPurchasedAnnualPass Parms{};
