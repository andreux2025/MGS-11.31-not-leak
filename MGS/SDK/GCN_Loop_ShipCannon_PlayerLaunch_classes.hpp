...
static_assert(sizeof(AGCN_Loop_ShipCannon_PlayerLaunch_C) == 0x000790, "Wrong size on AGCN_Loop_ShipCannon_PlayerLaunch_C");
static_assert(offsetof(AGCN_Loop_ShipCannon_PlayerLaunch_C, UberGraphFrame) == 0x000788, "Member 'AGCN_Loop_ShipCannon_PlayerLaunch_C::UberGraphFrame' has a wrong offset!");
