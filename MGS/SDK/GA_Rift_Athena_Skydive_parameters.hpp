...
public:
	...
	class AFortAthenaJackalVehicle*               K2Node_DynamicCast_AsFort_Athena_Jackal_Vehicle;   // 0x0160(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(GA_Rift_Athena_Skydive_C_ExecuteUbergraph_GA_Rift_Athena_Skydive, K2Node_DynamicCast_AsFort_Athena_Jackal_Vehicle) == 0x000160, "Member 'GA_Rift_Athena_Skydive_C_ExecuteUbergraph_GA_Rift_Athena_Skydive::K2Node_DynamicCast_AsFort_Athena_Jackal_Vehicle' has a wrong offset!");
