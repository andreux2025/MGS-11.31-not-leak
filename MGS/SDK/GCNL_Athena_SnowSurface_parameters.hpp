...
public:
	...
	TArray<class UParticleSystemComponent*>       K2Node_Event_ParticleComponents_1;                 // 0x01B8(0x0010)(ConstParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference)
	TArray<class UAudioComponent*>                K2Node_Event_AudioComponents_1;                    // 0x01C8(0x0010)(ConstParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference)
