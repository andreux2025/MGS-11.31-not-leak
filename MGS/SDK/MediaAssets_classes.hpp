...
static_assert(sizeof(UTimeSynchronizableMediaSource) == 0x000090, "Wrong size on UTimeSynchronizableMediaSource");
...
public:
	...
	uint8                                         Pad_648[0x1E8];                                    // 0x0648(0x01E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMediaSoundComponent, DynamicRateAdjustment) == 0x000624, "Member 'UMediaSoundComponent::DynamicRateAdjustment' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, RateAdjustmentFactor) == 0x000628, "Member 'UMediaSoundComponent::RateAdjustmentFactor' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, RateAdjustmentRange) == 0x00062C, "Member 'UMediaSoundComponent::RateAdjustmentRange' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, MediaPlayer) == 0x000640, "Member 'UMediaSoundComponent::MediaPlayer' has a wrong offset!");
