...
static_assert(sizeof(BP_FrontendBackPlate_C_UserConstructionScript) == 0x000028, "Wrong size on BP_FrontendBackPlate_C_UserConstructionScript");
...
static_assert(offsetof(BP_FrontendBackPlate_C_UserConstructionScript, CallFunc_GetAllActorsWithTag_OutActors) == 0x000010, "Member 'BP_FrontendBackPlate_C_UserConstructionScript::CallFunc_GetAllActorsWithTag_OutActors' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_UserConstructionScript, CallFunc_CreateDynamicMaterialInstance_ReturnValue_2) == 0x000020, "Member 'BP_FrontendBackPlate_C_UserConstructionScript::CallFunc_CreateDynamicMaterialInstance_ReturnValue_2' has a wrong offset!");
