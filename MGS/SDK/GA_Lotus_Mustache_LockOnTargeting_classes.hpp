...
public:
	...
	float                                         float_0;                                           // 0x0A44(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayAttribute                     Attribute;                                         // 0x0BA8(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	class AB_Ranged_Lotus_Mustache_C*             Weapon;                                            // 0x0BC8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         DotCheckValue;                                     // 0x0BD0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void TempGetLockOnTargetsTrace();
...
static_assert(sizeof(UGA_Lotus_Mustache_LockOnTargeting_C) == 0x000BD8, "Wrong size on UGA_Lotus_Mustache_LockOnTargeting_C");
...
static_assert(offsetof(UGA_Lotus_Mustache_LockOnTargeting_C, float_0) == 0x000A44, "Member 'UGA_Lotus_Mustache_LockOnTargeting_C::float_0' has a wrong offset!");
...
static_assert(offsetof(UGA_Lotus_Mustache_LockOnTargeting_C, Weapon) == 0x000BC8, "Member 'UGA_Lotus_Mustache_LockOnTargeting_C::Weapon' has a wrong offset!");
static_assert(offsetof(UGA_Lotus_Mustache_LockOnTargeting_C, DotCheckValue) == 0x000BD0, "Member 'UGA_Lotus_Mustache_LockOnTargeting_C::DotCheckValue' has a wrong offset!");
