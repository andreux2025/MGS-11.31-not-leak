...
static_assert(offsetof(FBox, max_0) == 0x00000C, "Member 'FBox::max_0' has a wrong offset!");
...
static_assert(offsetof(FBox2D, max_0) == 0x000008, "Member 'FBox2D::max_0' has a wrong offset!");
