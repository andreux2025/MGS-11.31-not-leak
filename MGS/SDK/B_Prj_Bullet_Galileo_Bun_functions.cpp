...
#include "B_Prj_Bullet_Galileo_Bun_classes.hpp"
#include "B_Prj_Bullet_Galileo_Bun_parameters.hpp"
...
void AB_Prj_Bullet_Galileo_Bun_C::ExecuteUbergraph_B_Prj_Bullet_Galileo_Bun(int32 EntryPoint)
{
	...
	Params::B_Prj_Bullet_Galileo_Bun_C_ExecuteUbergraph_B_Prj_Bullet_Galileo_Bun Parms{};
...
void AB_Prj_Bullet_Galileo_Bun_C::ReplacedPredictedProjectile(class AFortProjectileBase* PredictedProjectile)
{
	...
	Params::B_Prj_Bullet_Galileo_Bun_C_ReplacedPredictedProjectile Parms{};
...
void AB_Prj_Bullet_Galileo_Bun_C::ReplacedByRealProjectile(class AFortProjectileAthena* RealProjectile)
{
	...
	Params::B_Prj_Bullet_Galileo_Bun_C_ReplacedByRealProjectile Parms{};
...
void AB_Prj_Bullet_Galileo_Bun_C::BndEvt__CapsuleComponent_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Prj_Bullet_Galileo_Bun_C_BndEvt__CapsuleComponent_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature Parms{};
...
void AB_Prj_Bullet_Galileo_Bun_C::OnTouched(class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FHitResult& HitResult, bool bIsOverlap)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Prj_Bullet_Galileo_Bun_C_OnTouched Parms{};
...
void AB_Prj_Bullet_Galileo_Bun_C::OnStop(const struct FHitResult& Hit_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Prj_Bullet_Galileo_Bun_C_OnStop Parms{};
...
void AB_Prj_Bullet_Galileo_Bun_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;
...
void AB_Prj_Bullet_Galileo_Bun_C::PlayImpactSFX(bool IsPlayer, bool isWater_)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Prj_Bullet_Galileo_Bun_C_PlayImpactSFX Parms{};
