...
static_assert(offsetof(PerkTierWidgetNew_C_InitializeSettings, bUseLegacyFixedSizeIcons_0) == 0x000002, "Member 'PerkTierWidgetNew_C_InitializeSettings::bUseLegacyFixedSizeIcons_0' has a wrong offset!");
static_assert(offsetof(PerkTierWidgetNew_C_InitializeSettings, IconSize_0) == 0x000003, "Member 'PerkTierWidgetNew_C_InitializeSettings::IconSize_0' has a wrong offset!");
