...
static_assert(sizeof(USoundCueContainer) == 0x000480, "Wrong size on USoundCueContainer");
...
static_assert(sizeof(USoundCueDistanceCrossfade) == 0x000480, "Wrong size on USoundCueDistanceCrossfade");
