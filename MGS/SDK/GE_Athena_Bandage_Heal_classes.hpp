...
static_assert(alignof(UGE_Athena_Bandage_Heal_C) == 0x000008, "Wrong alignment on UGE_Athena_Bandage_Heal_C");
static_assert(sizeof(UGE_Athena_Bandage_Heal_C) == 0x000770, "Wrong size on UGE_Athena_Bandage_Heal_C");
