...
static_assert(sizeof(UCMSImage_C) == 0x000238, "Wrong size on UCMSImage_C");
static_assert(offsetof(UCMSImage_C, Image) == 0x000230, "Member 'UCMSImage_C::Image' has a wrong offset!");
