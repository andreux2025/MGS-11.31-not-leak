...
public:
	...
	EARWorldAlignment                             WorldAlignment;                                    // 0x0036(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EARSessionType                                SessionType;                                       // 0x0037(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EARPlaneDetectionMode                         PlaneDetectionMode;                                // 0x0038(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHorizontalPlaneDetection;                         // 0x0039(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bVerticalPlaneDetection;                           // 0x003A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bEnableAutoFocus;                                  // 0x003B(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EARLightEstimationMode                        LightEstimationMode;                               // 0x003C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EARFrameSyncMode                              FrameSyncMode;                                     // 0x003D(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bEnableAutomaticCameraOverlay;                     // 0x003E(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bEnableAutomaticCameraTracking;                    // 0x003F(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bResetCameraTracking;                              // 0x0040(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bResetTrackedObjects;                              // 0x0041(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARSessionConfig) == 0x0000A0, "Wrong size on UARSessionConfig");
...
static_assert(offsetof(UARSessionConfig, WorldAlignment) == 0x000036, "Member 'UARSessionConfig::WorldAlignment' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, SessionType) == 0x000037, "Member 'UARSessionConfig::SessionType' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, PlaneDetectionMode) == 0x000038, "Member 'UARSessionConfig::PlaneDetectionMode' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, bHorizontalPlaneDetection) == 0x000039, "Member 'UARSessionConfig::bHorizontalPlaneDetection' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, bVerticalPlaneDetection) == 0x00003A, "Member 'UARSessionConfig::bVerticalPlaneDetection' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, bEnableAutoFocus) == 0x00003B, "Member 'UARSessionConfig::bEnableAutoFocus' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, LightEstimationMode) == 0x00003C, "Member 'UARSessionConfig::LightEstimationMode' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, FrameSyncMode) == 0x00003D, "Member 'UARSessionConfig::FrameSyncMode' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, bEnableAutomaticCameraOverlay) == 0x00003E, "Member 'UARSessionConfig::bEnableAutomaticCameraOverlay' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, bEnableAutomaticCameraTracking) == 0x00003F, "Member 'UARSessionConfig::bEnableAutomaticCameraTracking' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, bResetCameraTracking) == 0x000040, "Member 'UARSessionConfig::bResetCameraTracking' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, bResetTrackedObjects) == 0x000041, "Member 'UARSessionConfig::bResetTrackedObjects' has a wrong offset!");
...
static_assert(sizeof(AARSharedWorldGameState) == 0x0002B0, "Wrong size on AARSharedWorldGameState");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageData) == 0x000278, "Member 'AARSharedWorldGameState::PreviewImageData' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldData) == 0x000288, "Member 'AARSharedWorldGameState::ARWorldData' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageBytesTotal) == 0x000298, "Member 'AARSharedWorldGameState::PreviewImageBytesTotal' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldBytesTotal) == 0x00029C, "Member 'AARSharedWorldGameState::ARWorldBytesTotal' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageBytesDelivered) == 0x0002A0, "Member 'AARSharedWorldGameState::PreviewImageBytesDelivered' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldBytesDelivered) == 0x0002A4, "Member 'AARSharedWorldGameState::ARWorldBytesDelivered' has a wrong offset!");
