...
static_assert(sizeof(AGCNL_Athena_SnowSurface_C) == 0x000790, "Wrong size on AGCNL_Athena_SnowSurface_C");
static_assert(offsetof(AGCNL_Athena_SnowSurface_C, UberGraphFrame) == 0x000788, "Member 'AGCNL_Athena_SnowSurface_C::UberGraphFrame' has a wrong offset!");
