...
static_assert(offsetof(StatsListWidget_C_AdjustClampCount, Temp_int_Variable_1) == 0x000094, "Member 'StatsListWidget_C_AdjustClampCount::Temp_int_Variable_1' has a wrong offset!");
static_assert(offsetof(StatsListWidget_C_AdjustClampCount, CallFunc_EqualEqual_IntInt_ReturnValue_1) == 0x000098, "Member 'StatsListWidget_C_AdjustClampCount::CallFunc_EqualEqual_IntInt_ReturnValue_1' has a wrong offset!");
