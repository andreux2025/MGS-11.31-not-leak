...
public:
	...
	struct FGameplayAttribute                     Attribute;                                         // 0x0A78(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	struct FGameplayTag                           MuzzleFlash;                                       // 0x0A98(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGA_Ranged_Mustache_Attribute_C) == 0x000AA0, "Wrong size on UGA_Ranged_Mustache_Attribute_C");
...
static_assert(offsetof(UGA_Ranged_Mustache_Attribute_C, MuzzleFlash) == 0x000A98, "Member 'UGA_Ranged_Mustache_Attribute_C::MuzzleFlash' has a wrong offset!");
