...
static_assert(alignof(UGE_SquadStatBonus_C) == 0x000008, "Wrong alignment on UGE_SquadStatBonus_C");
static_assert(sizeof(UGE_SquadStatBonus_C) == 0x000770, "Wrong size on UGE_SquadStatBonus_C");
