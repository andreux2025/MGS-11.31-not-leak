...
static_assert(alignof(ResonanceAudioReverbPluginPreset_SetRoomDimensions) == 0x000004, "Wrong alignment on ResonanceAudioReverbPluginPreset_SetRoomDimensions");
static_assert(sizeof(ResonanceAudioReverbPluginPreset_SetRoomDimensions) == 0x00000C, "Wrong size on ResonanceAudioReverbPluginPreset_SetRoomDimensions");
...
static_assert(alignof(ResonanceAudioReverbPluginPreset_SetRoomPosition) == 0x000004, "Wrong alignment on ResonanceAudioReverbPluginPreset_SetRoomPosition");
static_assert(sizeof(ResonanceAudioReverbPluginPreset_SetRoomPosition) == 0x00000C, "Wrong size on ResonanceAudioReverbPluginPreset_SetRoomPosition");
...
static_assert(sizeof(ResonanceAudioReverbPluginPreset_SetRoomRotation) == 0x000010, "Wrong size on ResonanceAudioReverbPluginPreset_SetRoomRotation");
