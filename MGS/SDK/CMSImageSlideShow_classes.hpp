...
public:
	...
	TMulticastInlineDelegate<void(int32 CurrentPageIndex)> CarouselIndexChanged;                              // 0x0248(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
