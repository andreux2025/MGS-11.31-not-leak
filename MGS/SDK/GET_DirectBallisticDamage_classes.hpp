...
static_assert(alignof(UGET_DirectBallisticDamage_C) == 0x000008, "Wrong alignment on UGET_DirectBallisticDamage_C");
static_assert(sizeof(UGET_DirectBallisticDamage_C) == 0x000770, "Wrong size on UGET_DirectBallisticDamage_C");
