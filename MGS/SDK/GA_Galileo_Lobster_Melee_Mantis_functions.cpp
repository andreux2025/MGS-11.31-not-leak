...
void UGA_Galileo_Lobster_Melee_Mantis_C::BP_OnMantisAttackHit(const struct FGameplayAbilityTargetDataHandle& TargetDataHandle, const struct FGameplayTag& ApplicationTag)
{
	static class UFunction* Func = nullptr;
	...
	Params::GA_Galileo_Lobster_Melee_Mantis_C_BP_OnMantisAttackHit Parms{};
