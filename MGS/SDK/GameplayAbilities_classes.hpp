...
static_assert(offsetof(UAbilitySystemComponent, OutgoingDuration) == 0x000310, "Member 'UAbilitySystemComponent::OutgoingDuration' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, IncomingDuration) == 0x000314, "Member 'UAbilitySystemComponent::IncomingDuration' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, ClientDebugStrings) == 0x000338, "Member 'UAbilitySystemComponent::ClientDebugStrings' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, ServerDebugStrings) == 0x000348, "Member 'UAbilitySystemComponent::ServerDebugStrings' has a wrong offset!");
...
static_assert(offsetof(UAbilitySystemComponent, bCachedIsNetSimulated) == 0x000778, "Member 'UAbilitySystemComponent::bCachedIsNetSimulated' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, bPendingMontageRep) == 0x000779, "Member 'UAbilitySystemComponent::bPendingMontageRep' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, LocalAnimMontageInfo) == 0x000780, "Member 'UAbilitySystemComponent::LocalAnimMontageInfo' has a wrong offset!");
...
static_assert(sizeof(UGameplayAbilityBlueprint) == 0x0000D8, "Wrong size on UGameplayAbilityBlueprint");
...
public:
	...
	int32                                         StackLimitCount;                                   // 0x0754(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGameplayEffect) == 0x000770, "Wrong size on UGameplayEffect");
...
static_assert(offsetof(UGameplayEffect, PeriodicInhibitionPolicy) == 0x0001E9, "Member 'UGameplayEffect::PeriodicInhibitionPolicy' has a wrong offset!");
...
static_assert(offsetof(UGameplayEffect, RemovalTagRequirements) == 0x0003F8, "Member 'UGameplayEffect::RemovalTagRequirements' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, RemoveGameplayEffectsWithTags) == 0x000438, "Member 'UGameplayEffect::RemoveGameplayEffectsWithTags' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, GrantedApplicationImmunityTags) == 0x000498, "Member 'UGameplayEffect::GrantedApplicationImmunityTags' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, GrantedApplicationImmunityQuery) == 0x0004D8, "Member 'UGameplayEffect::GrantedApplicationImmunityQuery' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, RemoveGameplayEffectQuery) == 0x000618, "Member 'UGameplayEffect::RemoveGameplayEffectQuery' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, StackingType) == 0x000751, "Member 'UGameplayEffect::StackingType' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, StackLimitCount) == 0x000754, "Member 'UGameplayEffect::StackLimitCount' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, StackDurationRefreshPolicy) == 0x000758, "Member 'UGameplayEffect::StackDurationRefreshPolicy' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, StackPeriodResetPolicy) == 0x000759, "Member 'UGameplayEffect::StackPeriodResetPolicy' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, StackExpirationPolicy) == 0x00075A, "Member 'UGameplayEffect::StackExpirationPolicy' has a wrong offset!");
static_assert(offsetof(UGameplayEffect, GrantedAbilities) == 0x000760, "Member 'UGameplayEffect::GrantedAbilities' has a wrong offset!");
