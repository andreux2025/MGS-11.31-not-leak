...
public:
	...
	struct FPostProcessSettings                   K2Node_MakeStruct_PostProcessSettings;             // 0x0540(0x0530)()
};
...
static_assert(sizeof(StormCameraModifier_C_BlueprintModifyPostProcess) == 0x000A70, "Wrong size on StormCameraModifier_C_BlueprintModifyPostProcess");
...
static_assert(offsetof(StormCameraModifier_C_BlueprintModifyPostProcess, K2Node_MakeStruct_PostProcessSettings) == 0x000540, "Member 'StormCameraModifier_C_BlueprintModifyPostProcess::K2Node_MakeStruct_PostProcessSettings' has a wrong offset!");
