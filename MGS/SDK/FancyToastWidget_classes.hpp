...
public:
	...
	TMulticastInlineDelegate<void()>              OnFinishedToast;                                   // 0x02B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void()>              OnToastClicked;                                    // 0x02E8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(sizeof(UFancyToastWidget_C) == 0x000300, "Wrong size on UFancyToastWidget_C");
static_assert(offsetof(UFancyToastWidget_C, UberGraphFrame) == 0x000258, "Member 'UFancyToastWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UFancyToastWidget_C, Outro) == 0x000260, "Member 'UFancyToastWidget_C::Outro' has a wrong offset!");
static_assert(offsetof(UFancyToastWidget_C, Intro) == 0x000268, "Member 'UFancyToastWidget_C::Intro' has a wrong offset!");
static_assert(offsetof(UFancyToastWidget_C, Description) == 0x000270, "Member 'UFancyToastWidget_C::Description' has a wrong offset!");
static_assert(offsetof(UFancyToastWidget_C, DescriptionRegular) == 0x000278, "Member 'UFancyToastWidget_C::DescriptionRegular' has a wrong offset!");
static_assert(offsetof(UFancyToastWidget_C, RegularToast) == 0x000280, "Member 'UFancyToastWidget_C::RegularToast' has a wrong offset!");
static_assert(offsetof(UFancyToastWidget_C, SmallPreviewPortrait) == 0x000288, "Member 'UFancyToastWidget_C::SmallPreviewPortrait' has a wrong offset!");
static_assert(offsetof(UFancyToastWidget_C, SpecialToast) == 0x000290, "Member 'UFancyToastWidget_C::SpecialToast' has a wrong offset!");
static_assert(offsetof(UFancyToastWidget_C, Title) == 0x000298, "Member 'UFancyToastWidget_C::Title' has a wrong offset!");
static_assert(offsetof(UFancyToastWidget_C, TitleRegular) == 0x0002A0, "Member 'UFancyToastWidget_C::TitleRegular' has a wrong offset!");
static_assert(offsetof(UFancyToastWidget_C, TypeWidgetSwitcher) == 0x0002A8, "Member 'UFancyToastWidget_C::TypeWidgetSwitcher' has a wrong offset!");
static_assert(offsetof(UFancyToastWidget_C, OnFinishedToast) == 0x0002B0, "Member 'UFancyToastWidget_C::OnFinishedToast' has a wrong offset!");
static_assert(offsetof(UFancyToastWidget_C, Dev_TestImage) == 0x0002C0, "Member 'UFancyToastWidget_C::Dev_TestImage' has a wrong offset!");
static_assert(offsetof(UFancyToastWidget_C, OnToastClicked) == 0x0002E8, "Member 'UFancyToastWidget_C::OnToastClicked' has a wrong offset!");
static_assert(offsetof(UFancyToastWidget_C, DoNotUseTimerToDismiss) == 0x0002F8, "Member 'UFancyToastWidget_C::DoNotUseTimerToDismiss' has a wrong offset!");
