...
static_assert(sizeof(UGA_AthenaEnterVehicle_C) == 0x000A38, "Wrong size on UGA_AthenaEnterVehicle_C");
static_assert(offsetof(UGA_AthenaEnterVehicle_C, UberGraphFrame) == 0x000A30, "Member 'UGA_AthenaEnterVehicle_C::UberGraphFrame' has a wrong offset!");
