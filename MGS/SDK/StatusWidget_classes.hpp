...
static_assert(sizeof(UStatusWidget_C) == 0x0004A8, "Wrong size on UStatusWidget_C");
static_assert(offsetof(UStatusWidget_C, UberGraphFrame) == 0x0004A0, "Member 'UStatusWidget_C::UberGraphFrame' has a wrong offset!");
