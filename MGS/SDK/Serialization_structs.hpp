...
static_assert(sizeof(FStructSerializerTestStruct) == 0x000440, "Wrong size on FStructSerializerTestStruct");
...
static_assert(offsetof(FStructSerializerTestStruct, Maps) == 0x0001C0, "Member 'FStructSerializerTestStruct::Maps' has a wrong offset!");
static_assert(offsetof(FStructSerializerTestStruct, Sets) == 0x000300, "Member 'FStructSerializerTestStruct::Sets' has a wrong offset!");
