...
static_assert(alignof(UGE_TrapCooldownGeneric_C) == 0x000008, "Wrong alignment on UGE_TrapCooldownGeneric_C");
static_assert(sizeof(UGE_TrapCooldownGeneric_C) == 0x000770, "Wrong size on UGE_TrapCooldownGeneric_C");
