...
public:
	...
	class UImage*                                 No_Count;                                          // 0x02D0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UImage*                                 No_Count_1;                                        // 0x02D8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(offsetof(UNormalBangWrapper_C, No_Count) == 0x0002D0, "Member 'UNormalBangWrapper_C::No_Count' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, No_Count_1) == 0x0002D8, "Member 'UNormalBangWrapper_C::No_Count_1' has a wrong offset!");
