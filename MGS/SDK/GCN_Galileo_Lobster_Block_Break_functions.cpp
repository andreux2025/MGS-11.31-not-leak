...
#include "GCN_Galileo_Lobster_Block_Break_classes.hpp"
#include "GCN_Galileo_Lobster_Block_Break_parameters.hpp"
...
void UGCN_Galileo_Lobster_Block_Break_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Galileo_Lobster_Block_Break_C", "OnBurst");

	Params::GCN_Galileo_Lobster_Block_Break_C_OnBurst Parms{};
