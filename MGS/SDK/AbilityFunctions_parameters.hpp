...
static_assert(sizeof(AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec) == 0x0001D0, "Wrong size on AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec");
...
static_assert(offsetof(AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec, CallFunc_GetValueAtLevel_ReturnValue) == 0x0001C8, "Member 'AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec::CallFunc_GetValueAtLevel_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AbilityFunctions_C_GetRangeFromGameplayEffectContainer) == 0x0001D0, "Wrong size on AbilityFunctions_C_GetRangeFromGameplayEffectContainer");
...
static_assert(offsetof(AbilityFunctions_C_GetRangeFromGameplayEffectContainer, CallFunc_GetValueAtLevel_ReturnValue) == 0x0001C8, "Member 'AbilityFunctions_C_GetRangeFromGameplayEffectContainer::CallFunc_GetValueAtLevel_ReturnValue' has a wrong offset!");
