...
static_assert(sizeof(ChatWidget_C_HandlePreShowConfirmationDialog) == 0x000120, "Wrong size on ChatWidget_C_HandlePreShowConfirmationDialog");
...
static_assert(offsetof(ChatWidget_C_InitializeChat, Temp_bool_Variable_1) == 0x000010, "Member 'ChatWidget_C_InitializeChat::Temp_bool_Variable_1' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_InitializeChat, Temp_byte_Variable_1) == 0x000014, "Member 'ChatWidget_C_InitializeChat::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_InitializeChat, CallFunc_GetContext_ReturnValue_1) == 0x000018, "Member 'ChatWidget_C_InitializeChat::CallFunc_GetContext_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_InitializeChat, CallFunc_GetContext_ReturnValue_2) == 0x000028, "Member 'ChatWidget_C_InitializeChat::CallFunc_GetContext_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_InitializeChat, K2Node_Select_Default_1) == 0x000040, "Member 'ChatWidget_C_InitializeChat::K2Node_Select_Default_1' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_HandleInputMethodChanged, InputType) == 0x000000, "Member 'ChatWidget_C_HandleInputMethodChanged::InputType' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_ExecuteUbergraph_ChatWidget, K2Node_CustomEvent_InputType) == 0x000004, "Member 'ChatWidget_C_ExecuteUbergraph_ChatWidget::K2Node_CustomEvent_InputType' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_ExecuteUbergraph_ChatWidget, K2Node_CreateDelegate_OutputDelegate_1) == 0x000018, "Member 'ChatWidget_C_ExecuteUbergraph_ChatWidget::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_ExecuteUbergraph_ChatWidget, K2Node_CreateDelegate_OutputDelegate_2) == 0x000028, "Member 'ChatWidget_C_ExecuteUbergraph_ChatWidget::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_ExecuteUbergraph_ChatWidget, K2Node_CreateDelegate_OutputDelegate_3) == 0x000038, "Member 'ChatWidget_C_ExecuteUbergraph_ChatWidget::K2Node_CreateDelegate_OutputDelegate_3' has a wrong offset!");
