...
static_assert(sizeof(UBehaviorTreeComponent) == 0x000268, "Wrong size on UBehaviorTreeComponent");
...
public:
	...
	TMulticastInlineDelegate<void(class AActor* MovingActor, struct FVector& DestinationPoint)> OnSmartLinkReached;                                // 0x0258(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UEnvQueryTest_Volume) == 0x0001D8, "Wrong size on UEnvQueryTest_Volume");
static_assert(offsetof(UEnvQueryTest_Volume, VolumeContext) == 0x0001C0, "Member 'UEnvQueryTest_Volume::VolumeContext' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Volume, VolumeClass) == 0x0001C8, "Member 'UEnvQueryTest_Volume::VolumeClass' has a wrong offset!");
...
static_assert(sizeof(UEQSRenderingComponent) == 0x000410, "Wrong size on UEQSRenderingComponent");
