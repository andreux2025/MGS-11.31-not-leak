...
static_assert(sizeof(UPlayerRankEmblem_C) == 0x000278, "Wrong size on UPlayerRankEmblem_C");
static_assert(offsetof(UPlayerRankEmblem_C, UberGraphFrame) == 0x000258, "Member 'UPlayerRankEmblem_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UPlayerRankEmblem_C, Flash) == 0x000260, "Member 'UPlayerRankEmblem_C::Flash' has a wrong offset!");
static_assert(offsetof(UPlayerRankEmblem_C, PlayerBanner) == 0x000268, "Member 'UPlayerRankEmblem_C::PlayerBanner' has a wrong offset!");
static_assert(offsetof(UPlayerRankEmblem_C, BindToLocalPlayerByDefault) == 0x000270, "Member 'UPlayerRankEmblem_C::BindToLocalPlayerByDefault' has a wrong offset!");
