...
void AB_Athena_Pickaxe_DualWield_Generic_C::PlayCQCPickaxeEnemyAudio(const struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Athena_Pickaxe_DualWield_Generic_C_PlayCQCPickaxeEnemyAudio Parms{};
...
void AB_Athena_Pickaxe_DualWield_Generic_C::Impact_Sequence(const struct FHitResult& Hit_Result, EPhysicalSurface IMpact_Physical_Surface, class UFXSystemComponent* SpawnedPSC)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Athena_Pickaxe_DualWield_Generic_C_Impact_Sequence Parms{};
