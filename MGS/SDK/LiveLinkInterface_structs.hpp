...
// Enum LiveLinkInterface.ELiveLinkAxis
// NumValues: 0x0007
...
{
public:
	struct FLiveLinkWorldTime                     WorldTime;                                         // 0x0000(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	int32                                         FrameDelay;                                        // 0x0008(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FLiveLinkTimeSynchronizationSettings, FrameDelay) == 0x000008, "Member 'FLiveLinkTimeSynchronizationSettings::FrameDelay' has a wrong offset!");
